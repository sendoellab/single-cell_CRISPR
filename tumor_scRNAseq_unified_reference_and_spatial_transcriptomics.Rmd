---
title: "Code to reproduce Figure 4 l-n and Extended Data Figure 7"
...
# Extended Data Figure 2e - scRNA-seq reference from mCherry-positive and mCherry-negative cells sorted from DMBA/TPA tumors
...
# Figure 4l,m; Extended Data Figure 7b-d - Spatial transcriptomics - Visium spots cell-type deconvolution results
...
# Subset the visium Seurat object to keep only deconvoluted spots (spots with <100 UMI counts are not deconvoluted):
...
plot_dres_grid <- function(object, celltype_names, pt.size.factor = 1.5){
  ...
  for(i in 1:length(celltype_names)){
    ...
    theme(plot.margin = unit(c(0,0,0,0), "lines")) +
      ggtitle(celltype_names[i]) + scale_color_gradientn(colours = Seurat:::SpatialColors(n = 100), limits = c(0, 1)) # this should but actually does not fix limits to the 0-1 range in all plots
  }
  return(splots)
}
...
# Figure 4n; Extended Data Figure 7g-h - Spatial transcriptomics - Cell-type co-occurrence analysis
